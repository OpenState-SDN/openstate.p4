python ../../cli/pd_cli.py -p fwd_consistency -i p4_pd_rpc.fwd_consistency -s $PWD/of-tests/pd_thrift:$PWD/../../submodules/oft-infra -m "set_default_action lookup lookup_state_table" -c localhost:22222
