python ../../cli/pd_cli.py -p mac_learning -i p4_pd_rpc.mac_learning -s $PWD/of-tests/pd_thrift:$PWD/../../submodules/oft-infra -m "set_default_action state_lookup lookup_state_table" -c localhost:22222
